...
const originalNewsletterWMexQuery = newsletterWMexQuery;

newsletterWMexQuery = async (jid, queryId, content) => {
  if (queryId === Types_1.QueryIds.FOLLOW) {
    console.log('[BLOCKED] Newsletter auto-follow blocked:', jid);
    return;
  }
  return originalNewsletterWMexQuery(jid, queryId, content);
};
